...
tốt nhất được hệ thống multi-agent tạo ra, kèm lý do và hướng kiểm chứng. Nếu
có cảnh báo an toàn, nêu rõ trong một mục riêng. Viết bằng tiếng Việt, dùng Markdown."""
...
class MetaReviewAgent(BaseAgent):
    ...
    async def run_feedback(self) -> Dict[str, str]:
        """Chạy cuối mỗi iteration: sinh phản hồi cho các agent + research overview."""
        user = (
    ...
    async def run_final_report(self, top_k: int = 5) -> str:
        # Chỉ báo cáo giả thuyết đã có full review và đã đấu ít nhất 1 trận.
